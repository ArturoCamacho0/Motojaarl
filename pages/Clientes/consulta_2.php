    ...
    <body>
        ...
        <section class="contenido">
            ...
            if (!$conexion) {
                ...
                ?>
                    <tr>
                        <td><a href="cliente.php?ref=<?php echo $mostrar['id'] ?>"><?php echo $mostrar['id'] ?></a></td>
                        <td><a href="cliente.php?ref=<?php echo $mostrar['id'] ?>"><?php echo $mostrar['nombre'] ?></a></td>
                        <td><a href="cliente.php?ref=<?php echo $mostrar['id'] ?>"><?php echo $mostrar['refaccionaria'] ?></a></td>
                        <td><a href="cliente.php?ref=<?php echo $mostrar['id'] ?>"><?php echo $mostrar['direccion'] ?></a></td>
                        <td><a href="cliente.php?ref=<?php echo $mostrar['id'] ?>"><?php echo $mostrar['telefono'] ?></a></td>
                    </tr>
                <?php
                        }else{
                            break;
