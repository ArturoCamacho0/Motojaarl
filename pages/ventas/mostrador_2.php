    ...
    <body>
        ...
        <section class="contenido">
            ...
            if (!$conexion) {
                ...
                ?>
                    <tr>
                        <td><a href="mostrador_1.php?ref=<?php echo $mostrar['clave'] ?>"><?php echo $mostrar['clave'] ?></a></td>
                        <td><a href="mostrador_1.php?ref=<?php echo $mostrar['clave'] ?>"><?php echo $mostrar['nombre'] ?></a></td>
                        <td><a href="mostrador_1.php?ref=<?php echo $mostrar['clave'] ?>"><?php echo $mostrar['descripcion'] ?></a></td>
                        <td><a href="mostrador_1.php?ref=<?php echo $mostrar['clave'] ?>"><?php echo $mostrar['tipo'] ?></a></td>
                        <td><a href="mostrador_1.php?ref=<?php echo $mostrar['clave'] ?>"><?php echo $mostrar['existencia'] ?></a></td>
                    </tr>
                <?php
                        }else{
                            break;
