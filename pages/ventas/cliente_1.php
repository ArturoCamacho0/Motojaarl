...
<html lang="es">
    ...
    <body>
        ...
        <section class="contenido">
            <h2>Venta de refacciones para Clientes</h2>
            <form class="consulta_form" method="POST" action="cliente_2.php">
            ...
            <form id="v" method="POST" action="cliente_3.php">
                <input class="in re" type="text" name="refacciones"/>
                <input class="in" type="text" name="cliente" value="mayoreo"/>
                ...
                if(isset($_GET['ref'])){
                    ...
                    if($clave){
                        ...
                        if(!$conexion){
                            ...
                            $precio = (float)($mostrar['precio_compra'] * 0.10) + $mostrar['precio_compra'];
