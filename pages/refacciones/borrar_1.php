...
<html lang="es">
    ...
    <body>
        ...
        <section class="contenido">
            <h2>Borrar refacciones</h2>
            <form class="consulta_form" method="POST" action="borrar_2.php">
                <h3>Consultar refacción</h3>
                <label for="clave">Ingrese la clave del producto que desea borrar</label>
            ...
            <form class="consulta_form" method="POST" action="borrar_2.php">
                ...
                <label for="nombre">Ingrese el nombre del producto que desea borrar</label>
